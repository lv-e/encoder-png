...
if (!testing) {
    ...
    fs.createReadStream(cli.flags.input)
        ...
        if (cli.flags.compress) {
            ...
            const planes = compressor_1.splitInPlanes(indexed.pixels, this.width, this.height, false, exports.verbose);
            planes.forEach(plane => compressed = compressed.concat(compressor_1.bitPlane(plane)));
