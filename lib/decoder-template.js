...
exports.decoder_template_on_exit = exports.decoder_template_on_enter = exports.decoder_template_declarations = exports.replaceAll = void 0;
function replaceAll(subject, search, replace) {
    return subject.split(search).join(replace);
}
exports.replaceAll = replaceAll;
exports.decoder_template_declarations = `
