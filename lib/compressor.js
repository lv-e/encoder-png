...
exports.splitInPlanes = exports.decodeLength = exports.encodeLength = exports.header = exports.compressBitPlane = exports.bits2Int = exports.number2Bits = void 0;
...
function header(data) {
    ...
    */
    ...
    if (data.colors <= 2)
        buffer = buffer.concat([0, 1]);
    else if (data.colors <= 4)
        buffer = buffer.concat([1, 0]);
    else if (data.colors <= 8)
        buffer = buffer.concat([1, 1]);
    else
        buffer = buffer.concat([0, 0]);
    return buffer;
}
