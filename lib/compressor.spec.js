...
test("header generation", () => {
    let hdr2 = compressor_1.header({ width: 512, height: 512, colors: 2 });
    expect(hdr2).toStrictEqual([1, 1, 1, 1, 1, 1, 0, 1]);
    let hdr6 = compressor_1.header({ width: 256, height: 128, colors: 6 });
    expect(hdr6).toStrictEqual([1, 1, 0, 1, 0, 1, 1, 1]);
    let hdr16 = compressor_1.header({ width: 128, height: 128, colors: 16 });
